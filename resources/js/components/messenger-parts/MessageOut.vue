    ...
    <div class="d-flex flex-column align-items-end">
      ...
      <div class="d-flex align-items-center mb-2">
        ...
        <div class="me-3">
          ...
          <span href="#" class="fs-5 fw-bold text-gray-900 text-hover-primary ms-1"
            >You</span
          >
        </div>
        <!--end::Details-->
      ...
      <!--begin::Text-->
      <div v-if="text"
        class="p-5 rounded bg-light-primary text-dark fw-semobold mw-lg-400px text-start"
      ...
      <div v-else-if="fileExtension === 'application/msword' || fileExtension === 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet'">
        <a :href="fileUrl" target="_blank" style="display: flex; justify-content: center;">
          ...
          <div>
            <a v-if="fileUrl" :href="fileUrl" target="_blank">
                    <img class="file p-2" v-if="fileUrl" :src="getImageByExtension(fileUrl)" alt="">
                  </a>
