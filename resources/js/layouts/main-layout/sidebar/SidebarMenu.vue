  ...
  <div class="app-sidebar-menu overflow-hidden flex-column-fluid">
    ...
    >
      ...
      >
        ...
        <template v-if="userRole ==='Admin'" v-for="(item, i) in MainMenuConfig" :key="i">
        ...
        <!-- <template v-if="userRole ==='Client'" v-for="(item, i) in MainMenuConfigCustomer" :key="i">
          <div v-if="item.heading" class="menu-item pt-5">
            <div class="menu-content">
              <span class="menu-heading fw-bold text-uppercase fs-7">
                {{ translate(item.heading) }}
      ...
      ApiService.get("/api/user-details")
        .then(({data}) => {
          if(data.success == true){
            ...
            userRole.value = data.data.role.role;
          }else{
            // console.log();
          }data
        })
