  ...
  >
    ...
    <div class="menu-item px-3">
      <div class="menu-content d-flex align-items-center px-3">
        <!--begin::Avatar-->
        <div @click="setId(myData.uuid)" class="symbol symbol-50px me-5" style="cursor: pointer;">
          <img alt="Logo" :src="getAssetPath('images/profile_icon.png')" />
        </div>
        <!--end::Avatar-->

        <!--begin::Username-->
        <div @click="setId(myData.uuid)" class="d-flex flex-column" style="cursor: pointer;">
